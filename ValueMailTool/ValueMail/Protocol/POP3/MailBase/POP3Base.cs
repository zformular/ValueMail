...
using ValueMail.POP3.Instruction;

namespace ValueMail.POP3.MailBase
{
    public class POP3Base : ValueMail.MailBase.MailBase
    {
        ...
        private MailHeadModel getMailHeader(Int32 index)
        {
            ...
            //ValueHelper.FileHelper file = new ValueHelper.FileHelper(@"E:\MailHeads.txt");
            //file.WriteContent(stringBuilder.ToString());
            return new MailHeadModel(uid, stringBuilder.ToString());
        }
        ...
        public override MailModel GetMail(Int32 index)
        {
            ...
            //ValueHelper.FileHelper file = new ValueHelper.FileHelper(@"E:\MailHeads.txt");
            //file.WriteContent(headSb.ToString());
            //file.WriteContent("");
            //file.WriteContent(bodySb.ToString());
            return new MailModel(uid, headSb.ToString(), bodySb.ToString());
        }
